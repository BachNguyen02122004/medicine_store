    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (typeof onSave === 'function') {
                onSave({ id: order.id, patientName, medicines: medicinesData, services: servicesData });
            }
    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
            ...
            <DialogContent>
                ...
                {Array.isArray(selectedDichVu) && selectedDichVu.length > 0 ? (
                    ...
                    <Typography sx={{ color: '#888', mb: 2 }}>Không có dịch vụ</Typography>
                )}
